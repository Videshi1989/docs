!(function (a, b, c, d) {
    function e(b, c) {
        (b.owlCarousel = { name: "Owl Carousel", author: "Bartosz Wojciechowski", version: "2.0.0-beta.2.1" }),
            (this.settings = null),
    ...
    var l, m, n, o, p, q, r, s;
    (l = { index: !1, indexAbs: !1, posLeft: !1, clone: !1, active: !1, loaded: !1, lazyLoad: !1, current: !1, width: !1, center: !1, page: !1, hasVideo: !1, playVideo: !1 }),
        (m = { el: null, $el: null, stage: null, $stage: null, oStage: null, $oStage: null, $items: null, $oItems: null, $cItems: null, $content: null }),
        (n = { el: 0, stage: 0, item: 0, prevWindow: 0, cloneLast: 0 }),
        (o = { items: 0, oItems: 0, cItems: 0, active: 0, merged: [] }),
        (q = { start: 0, startX: 0, startY: 0, current: 0, currentX: 0, currentY: 0, offsetX: 0, offsetY: 0, distance: null, startTime: 0, endTime: 0, updatedX: 0, targetEl: null }),
        (r = { isTouch: !1, isScrolling: !1, isSwiping: !1, direction: !1, inMotion: !1 }),
        (s = { _onDragStart: null, _onDragMove: null, _onDragEnd: null, _transitionEnd: null, _resizer: null, _responsiveCall: null, _goToLoop: null, _checkVisibile: null }),
        (e.Defaults = {
            items: 3,
            loop: !1,
            center: !1,
        ...
        (e.prototype.calculate = function () {
            var a,
                ...
                i = 0;
            for (
                this.width.el = this.dom.$el.width() - 2 * this.settings.stagePadding,
                ...
                this.settings.merge
                    ? ((g = this.dom.$items.eq(a).find("[data-merge]").attr("data-merge") || 1),
                    ...
                    this.settings.autoWidth &&
                        ((f = this.dom.$items.eq(a).width() + this.settings.margin),
            ...
            return (
                ...
                0 === this.num.oItems
                    ...
                    : (this.dom.$stage.addClass("owl-refresh"),
                      ...
                      a ? this.reset(a.data("owl-item").indexAbs) : ((this.dom.oStage.scrollLeft = 0), this.reset(this.dom.$oItems.eq(0).data("owl-item").indexAbs)),
        ...
        (e.prototype.updateActiveItems = function () {
            ...
            for (this.num.active = 0, padding = 2 * this.settings.stagePadding, stageX = this.coordinates(this.current()) + padding, view = this.settings.rtl ? this.width.view : -this.width.view, b = 0; b < this.num.items; b++)
                (c = this.dom.$items.eq(b)),
                    ...
                    ((this.op(d, "<=", stageX) && this.op(d, ">", stageX + view)) || (this.op(f, "<", stageX) && this.op(f, ">", stageX + view))) &&
                        (this.num.active++,
        ...
        (e.prototype.responsiveTimer = function () {
            return this.viewport() === this.width.prevWindow
                ? !1
                : (b.clearTimeout(this.resizeTimer), (this.resizeTimer = b.setTimeout(this.e._responsiveCall, this.settings.responsiveRefreshRate)), void (this.width.prevWindow = this.viewport()));
        }),
        (e.prototype.internalEvents = function () {
            ...
            (this.dragType = a && !d ? ["touchstart", "touchmove", "touchend", "touchcancel"] : a && d ? ["MSPointerDown", "MSPointerMove", "MSPointerUp", "MSPointerCancel"] : ["mousedown", "mousemove", "mouseup"]),
                (a || d) && this.settings.touchDrag
                    ? this.on(c, this.dragType[3], this.e._onDragEnd)
        ...
        (e.prototype.dragEvents = function () {
            !this.settings.touchDrag || ("touchstart" !== this.dragType[0] && "MSPointerDown" !== this.dragType[0])
                ? this.settings.mouseDrag && "mousedown" === this.dragType[0]
                    ? this.on(this.dom.stage, this.dragType[0], this.e._onDragStart, !1)
        ...
        (e.prototype.onDragStart = function (a) {
            ...
            if (
                ("mousedown" === this.dragType[0] && this.dom.$stage.addClass("owl-grab"),
                this.trigger("drag"),
                ...
                (this.state.isScrolling ||
                    ...
                    this.settings.loop
                        ? this.op(this.drag.currentX, ">", this.coordinates(this.minimum())) && "right" === this.state.direction
                            ...
                            : this.op(this.drag.currentX, "<", this.coordinates(this.maximum())) && "left" === this.state.direction && (this.drag.currentX += (this.settings.center && this.coordinates(0)) - this.coordinates(this.num.oItems))
        ...
        (e.prototype.onDragEnd = function () {
            ...
            if (this.state.isTouch) {
                if (
                    ("mousedown" === this.dragType[0] && this.dom.$stage.removeClass("owl-grab"),
        ...
        (e.prototype.animate = function (b) {
            this.trigger("translate"),
                ...
                this.support3d
                    ? this.dom.$stage.css({ transform: "translate3d(" + b + "px,0px, 0px)", transition: this.speed() / 1e3 + "s" })
                    : this.state.isTouch
                    ? this.dom.$stage.css({ left: b + "px" })
        ...
        (e.prototype.to = function (c, d) {
            if (this.settings.loop) {
                ...
                h < this.settings.items && i === !1
                    ? ((f = this.num.items - (this.settings.items - g) - this.settings.items), this.reset(f))
                    : h >= this.num.items - this.settings.items && i === !0 && ((f = g - this.num.oItems), this.reset(f)),
        ...
        (e.prototype.trigger = function (b, c, d) {
            ...
            return (
                this._supress[g.type] ||
                    (a.each(this.plugins, function (a, b) {
        ...
        (Video = function (b) {
            ...
            (Video.prototype.checkVideoLinks = function () {
                ...
                for (c = 0; c < this.owl.num.items; c++)
                    (b = this.owl.dom.$items.eq(c)),
                        b.data("owl-item").hasVideo ||
                            ((a = b.find(".owl-video")), a.length && ((this.owl.state.hasVideos = !0), (this.owl.dom.$items.eq(c).data("owl-item").hasVideo = !0), a.css("display", "none"), this.getVideoInfo(a, b)));
            }),
            ...
            (Video.prototype.createVideoTn = function (b, c) {
                ...
                var e,
                    ...
                    k = this.owl;
                return (
                    this.owl.settings.lazyLoad && ((i = "data-src"), (j = "owl-lazy")),
                    h.length
                        ? (d(h.attr(i)), h.remove(), !1)
                        : void ("youtube" === c.type
                              ? ((g = "http://img.youtube.com/vi/" + c.id + "/hqdefault.jpg"), d(g))
                              : "vimeo" === c.type &&
                                a.ajax({
                                    type: "GET",
            ...
            (Video.prototype.playVideo = function (b) {
                ...
                (e = g.data("owl-item").videoType),
                    ...
                    "youtube" === e
                        ? (c = '<iframe width="' + width + '" height="' + height + '" src="http://www.youtube.com/embed/' + id + "?autoplay=1&v=" + id + '" frameborder="0" allowfullscreen></iframe>')
                        : "vimeo" === e &&
                          (c = '<iframe src="http://player.vimeo.com/video/' + id + '?autoplay=1" width="' + width + '" height="' + height + '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'),
            ...
            (Video.prototype.isInFullScreen = function () {
                ...
                return (
                    d && a(d.parentNode).hasClass("owl-video-frame") && (this.owl.speed(0), (this.owl.state.isFullScreen = !0)),
                    d && this.owl.state.isFullScreen && this.owl.state.videoPlay
                        ? !1
                        : this.owl.state.isFullScreen
                        ? ((this.owl.state.isFullScreen = !1), !1)
                        : this.owl.state.videoPlay && this.owl.state.orientation !== b.orientation
                        ? ((this.owl.state.orientation = b.orientation), !1)
                        : !0
                );
            }),
    ...
    (function (a, b, c) {
        (Autoplay = function (b) {
            ...
            (Autoplay.Defaults = { autoplay: !1, autoplayTimeout: 5e3, autoplayHoverPause: !1, autoplaySpeed: !1 }),
        ...
        (b.Defaults = {
            ...
            (b.prototype.initialize = function () {
                ...
                d.dotsData || (this.template = a("<div>").addClass(d.dotClass).append(a("<span>")).prop("outerHTML")),
                    ...
                    this.controls.$indicators.on(
                        this.core.dragType[2],
                        "div",
                        a.proxy(function (b) {
            ...
            (b.prototype.draw = function () {
                ...
                if (
                    (!e.nav || e.loop || e.navRewind || (this.controls.$previous.toggleClass("disabled", 0 >= g), this.controls.$next.toggleClass("disabled", g >= this.core.maximum())),
            ...
            (b.prototype.getPosition = function (b) {
                ...
                return (
                    "page" == e.slideBy
                        ? ((c = a.inArray(this.current(), this.pages)), (d = this.pages.length), b ? ++c : --c, (c = this.pages[((c % d) + d) % d].start))
                        : ((c = this.core.normalize(this.core.current(), !0)), (d = this.core.num.oItems), b ? (c += e.slideBy) : (c -= e.slideBy)),
                    c
                );
            }),
